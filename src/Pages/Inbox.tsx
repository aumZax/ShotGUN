export default function Ibox() {
    return (
        <div className="pt-14 min-h-screen m-0 p-0 bg-black">
            <header className="w-full h-16 px-4 flex items-center justify-between bar-gray border-b border-gray-700 sticky top-0 z-40">
                <div className="flex items-center gap-3">
                    <span className="text-3xl font-normal text-gray-200 p-5">
                        Inbox
                    </span>
                    ...
                    {/* Action buttons */}
                    <button className="h-8 px-3 text-gray-300 text-sm flex items-center hover:bg-gray-800 rounded">
                        Hide Read Messages
                    </button>
                    ...
                    {/* Refresh button */}
                    <button className="w-12 h-8 flex items-center justify-center hover:bg-gray-800 rounded">
                         <img
            ...
            <main className="flex h-[calc(100vh-8rem)]">
                {/* Sidebar */}
                <aside className="w-130 bar-dark border-r border-gray-600 p-5">
