        ...
        <div className="min-h-screen flex flex-col bg-gray-900" onClick={handleClickOutside}>
            ...
            <div className="pt-12 flex-1">
                {section === 'Project_Assets' && (
                    <header className="w-full h-22 px-4 flex items-center justify-between bg-gray-800 fixed z-[50]">
                        <div className="flex flex-col">
                            ...
                            <div className="flex items-center gap-3 mt-2">
                                ...
                                <button className="px-4 h-8 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded flex items-center gap-1">
                                    Add Shot
