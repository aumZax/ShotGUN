                        ...
                        <div className="flex gap-6 w-full items-start justify-between mb-6">
                            <div className="relative">
                                {shotData.thumbnail ? (
                                    ...
                                    <div className="w-80 h-44 rounded-lg shadow-md border-2 border-gray-700 bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 flex flex-col items-center justify-center gap-3">
