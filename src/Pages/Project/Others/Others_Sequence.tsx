                        ...
                        <div className="flex gap-6 w-full items-start justify-between mb-6">
                            <div className="relative">
                                {shotData.thumbnail ? (
                                    ...
                                    <div className="w-80 h-44 rounded-lg shadow-md border-2 border-dashed border-gray-600 bg-gradient-to-br from-gray-700/30 via-gray-800/30 to-gray-900/30 flex flex-col items-center justify-center gap-3 hover:border-gray-500 hover:bg-gray-700/20 transition-all duration-300 cursor-pointer group">
